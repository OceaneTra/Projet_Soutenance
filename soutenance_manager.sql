...
--
-- Hôte : db
-- Généré le : dim. 29 juin 2025 à 16:23
...
(7, 8, 'Economie 1', 2, NULL),
(9, 8, 'Economie 2', 2, NULL),
(10, 13, 'Suites et fonctions', 3, NULL),
(11, 13, 'Calcul intégral', 2, NULL),
(12, 14, 'Elements de logique', 2, NULL),
(13, 14, 'Structures algébriques', 3, NULL),
...
(4, 2004003, 'rogggggggggggggggggggggggggg', 'zptmffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff', 'Académique', 'Moyenne', 'En attente', '2025-06-27 21:54:42', '2025-06-27 21:54:42', NULL);
...
(48, 'Analyse de données', 8, 19, 22524, 3, NULL),
...
--
ALTER TABLE `candidature_soutenance`
  MODIFY `id_candidature` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `enseignants`
  MODIFY `id_enseignant` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
ALTER TABLE `informations_stage`
  MODIFY `id_info_stage` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `utilisateur`
  MODIFY `id_utilisateur` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=89;
