...
INSERT INTO `approuver` (`id_approb`, `id_pers_admin`, `id_rapport`, `decision`, `date_approv`, `commentaire_approv`) VALUES
(3, 7, 5, 'approuve', '2025-06-29 19:21:24', 'Rapport bien rédiger et respectant les normes de mise en forme');
...
(6, 2003003, '2025-06-23 10:23:24', 'Rejetée', '2025-06-23 10:36:53', 6, 'Évaluation complète terminée'),
(7, 2003003, '2025-06-23 11:55:25', 'Rejetée', '2025-06-25 13:31:57', 6, 'Évaluation complète terminée'),
(9, 2004003, '2025-06-25 12:37:46', 'Validée', '2025-06-25 13:41:42', 6, 'Évaluation complète terminée'),
(10, 2003011, '2025-06-29 20:49:57', 'En attente', NULL, NULL, NULL);
...
INSERT INTO `dossier_academique` (`id_dossier`, `num_etu`, `date_creation`, `date_modification`, `adresse`, `telephone`, `nationalite`, `situation_familiale`, `dernier_diplome`, `etablissement_origine`, `annee_obtention_diplome`, `mention_diplome`) VALUES
(1, 2004003, '2025-06-21 17:03:27', '2025-06-21 17:21:02', 'Cocody, riviera palmeraie, quartier bonoumin', '0759395841', 'Ivoirienne', 'Marié', 'Baccalauréat', 'CSM Niangon', '2019', 'Assez bien');
...
(7, 8, 'Economie 1', 2, 10),
(9, 8, 'Economie 2', 2, 10),
(10, 13, 'Suites et fonctions', 3, 10),
(11, 13, 'Calcul intégral', 2, 10),
(12, 14, 'Elements de logique', 2, 10),
(13, 14, 'Structures algébriques', 3, 10),
(14, 17, 'Géométrie', 1, NULL),
(15, 17, 'Calcul matriciel', 2, NULL),
(16, 17, 'espaces vectoriels', 3, NULL),
(17, 18, 'Probabilités 1', 2, NULL),
(18, 18, 'Statistique 1', 2, NULL),
(19, 18, 'Initiation au langage R', 1, NULL),
(20, 82, 'Algorithmique', 3, NULL),
(21, 82, 'programmation Java', 2, NULL),
(22, 21, 'Methodologie de travail', 1, NULL),
(23, 21, 'Technique d\'expression', 1, NULL),
(24, 26, 'Fondamentaux de POO', 3, NULL),
(25, 26, 'Programmation POO', 3, NULL),
(26, 28, 'Analyse 2', 3, NULL),
(27, 28, 'Algèbre', 3, NULL),
(28, 29, 'Probabilités 2', 2, NULL),
(29, 29, 'Statistique 2', 2, NULL),
(30, 30, 'Modèle comptable', 2, NULL),
(31, 30, 'Opérations comptables', 2, NULL),
(32, 30, 'Opérations d\'inventaires', 2, NULL),
(33, 32, 'Arithmétique', 2, NULL),
(34, 33, 'Base de données relationnelles', 3, NULL),
(35, 33, 'Données semi-structurées', 2, NULL),
(36, 33, 'base de données et applications', 3, NULL),
(37, 35, 'Initiation au Langage SCALA', 2, NULL),
(38, 35, 'Atelier de Génie Logiciel', 4, NULL),
(39, 36, 'Programmation VBA', 2, NULL),
(40, 36, 'Programmation C#', 2, NULL),
(41, 38, 'Application à la cryptographie', 2, NULL),
(42, 40, 'Fondamentaux des systèmes d\'exploitation', 2, NULL),
(43, 40, 'UNIX et langage C', 4, NULL),
(44, 41, 'Algo avancé et Java', 5, NULL),
(45, 46, 'Suivi des performances', 2, NULL),
(46, 46, 'Coût complet et coût partiel', 2, NULL),
(47, 9, 'Fondamentaux des réseaux', 3, NULL),
(48, 9, 'Internet/Intranet', 2, NULL),
(49, 56, 'ISI', 2, NULL),
(50, 56, 'UML', 3, NULL),
...
(12, 'Wah', 'Médard', 'wahmedard@gmail.com', 2, 'Simple'),
(13, 'Brou', 'IDA', 'brouida@gmail.com', 2, 'Administratif'),
(14, 'Tembely', 'Salifou', 'tembelysalifou@gmail.com', 15, 'Simple'),
(15, 'Kouabera', 'Tanoh', 'kouaberatanoh11@yahoo.com', 3, 'Simple'),
(16, 'Diarra', 'Mamadou', 'diarramamadou@gmail.com', 2, 'Administratif'),
(17, 'ASSOMA', 'ASSI VIRGINIE', 'tiamaoui@yahoo.fr', 2, 'Administratif');
...
(5, 2003003, 8, '2025-02-28', '2025-06-15', 'Développement d\'application mobile', 'Ce stage avait pour but d\'améliorer mes compétences en développement d\'application mobile avec flutter.', 'Yao Ferdinand', 'yaoferdinand@gmail.com', '+2250711489473'),
(6, 2003011, 8, '2024-08-12', '2025-01-13', 'Apprentissage des techniques d\'animation 3D', 'Amélioration des techniques d\'amélioration 3D', 'ASSI VIRGINIE ASSOMA', 'tiamaoui@yahoo.fr', '+2250708289628');
...
(18, 2003007, 7, 22221, '2025-06-03 00:57:34', 'En cours', 3, 40000.00, 850000.00),
...
(30, 2004003, 9, 21817, '2025-06-16 00:48:39', 'En cours', 1, 0.00, 1235000.00);
...
(6, 'Licence 1', 5, 870000.00, 450000.00),
(7, 'Licence 2', 2, 890000.00, 450000.00),
(8, 'Licence 3', 13, 910000.00, 500000.00),
(9, 'Master 2', 12, 1235000.00, 670000.00),
...
(5, 2004003, 73, NULL, 14.65, 'Bien', '2025-06-25 15:08:12', '2025-06-25 15:17:59'),
(6, 2004003, 81, NULL, 12.00, 'Assez bien', '2025-06-25 15:08:12', '2025-06-25 15:08:12'),
(7, 2004003, 76, NULL, 17.00, 'Très bien', '2025-06-25 15:08:12', '2025-06-25 15:08:12'),
(8, 2004003, 77, NULL, 12.00, 'Assez bien', '2025-06-25 15:08:12', '2025-06-25 15:08:12'),
(9, 2004003, 74, NULL, 13.00, 'Bien', '2025-06-25 15:08:12', '2025-06-25 15:08:12'),
(10, 2004003, 79, NULL, 12.00, 'Assez bien', '2025-06-25 15:08:12', '2025-06-25 15:08:12'),
(11, 2004003, 75, NULL, 7.00, 'Insuffisant', '2025-06-25 15:08:12', '2025-06-25 15:08:12'),
(12, 2004003, 80, NULL, 8.65, 'Insuffisant', '2025-06-25 15:08:13', '2025-06-25 15:17:59'),
(13, 2004003, 78, NULL, 12.00, 'Assez bien', '2025-06-25 15:08:13', '2025-06-25 15:08:13'),
(14, 2003005, 51, 46, 12.60, 'Assez bien', '2025-06-25 17:24:51', '2025-06-25 17:24:51'),
(15, 2003005, 51, 45, 18.00, 'Excellent', '2025-06-25 17:24:51', '2025-06-25 17:24:51');
...
(5, 2004003, 'Génération d\'une base de connaissance pour l\'IA', '2025-06-27 02:24:49', 'Intégration d\'une base intelligente', 'rapport_5.html', 'en_cours', '2025-06-27 02:24:49', 11780, 1),
(8, 2004003, 'Développement Web', '2025-06-27 20:09:48', 'Intégration d\'un système CRM', 'rapport_8.html', 'en_attente', '2025-06-27 20:09:48', 11771, 1),
(10, 2004003, 'Analyse de données', '2025-06-28 20:10:04', 'Régression multiple', 'rapport_10.html', 'en_attente', '2025-06-28 20:10:04', 11771, 1);
...
INSERT INTO `reclamations` (`id_reclamation`, `num_etu`, `titre_reclamation`, `description_reclamation`, `type_reclamation`, `priorite_reclamation`, `statut_reclamation`, `date_creation`, `date_mise_a_jour`, `id_pers_admin`) VALUES
(1, 2006002, 'Mes notes on été echanger', 'les chiennns la mes notes ahi vous avez quelle probleme bande de cafards', 'Académique', 'Moyenne', 'En attente', '2025-06-16 13:13:39', '2025-06-16 13:13:39', NULL),
(2, 2004003, 'Problème au niveau de mes notes', 'il y\' a une erreur au niveau de mes notes d\'anglais et d\'analyse de données', 'Académique', 'Moyenne', 'En attente', '2025-06-25 18:30:54', '2025-06-25 18:30:54', NULL),
(3, 2004003, 'oggggggggggggggggg', 'epppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppp', 'Académique', 'Moyenne', 'En attente', '2025-06-27 21:52:57', '2025-06-27 21:52:57', NULL),
(4, 2004003, 'rogggggggggggggggggggggggggg', 'zptmffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff', 'Académique', 'Moyenne', 'Rejetée', '2025-06-27 21:54:42', '2025-06-29 21:41:19', NULL);
...
(8, 'Economie', 6, 12, 22524, 5, NULL),
(9, 'Réseaux informatiques', 8, 19, 22423, 5, NULL),
(10, 'Initiation à l\'informatique', 6, 12, 22524, 4, NULL),
(11, 'Initiation à l\'algorithmique', 6, 12, 22524, 3, NULL),
(12, 'Outils bureautiques 1', 6, 12, 22524, 2, 10),
(13, 'Mathématiques 1', 6, 12, 22524, 5, NULL),
(14, 'Mathématiques 2', 6, 12, 22524, 5, NULL),
(15, 'Organisation des entreprises', 6, 12, 22524, 3, NULL),
(16, 'Électronique', 6, 12, 22524, 3, NULL),
(17, 'Mathématiques 3', 6, 15, 22524, 6, NULL),
(18, 'Probabilité et Statistique 1', 6, 15, 22524, 5, NULL),
(19, 'Outils bureautiques 2', 6, 15, 22524, 2, 10),
(20, 'Atelier de maintenance', 6, 15, 22524, 1, NULL),
(21, 'Technique d\'expression et méthodologie de travail', 6, 15, 22524, 2, NULL),
(22, 'Intelligence économique', 6, 15, 22524, 2, NULL),
(23, 'Gestion des Ressources Humaines', 6, 15, 22524, 2, NULL),
(24, 'Logiciel de traitement d\'images ou de montage vidéo', 6, 15, 22524, 2, NULL),
(25, 'Anglais', 6, 15, 22524, 3, NULL),
(26, 'Programmation orientée objet', 7, 16, 22524, 6, NULL),
(27, 'Outils formels pour l\'informatique', 7, 16, 22524, 2, 9),
(28, 'Mathématiques 4', 7, 16, 22524, 6, NULL),
(29, 'Probabilité et Statistique 2', 7, 16, 22524, 4, NULL),
(30, 'Comptabilité generale', 7, 16, 22524, 6, NULL),
(31, 'Anglais', 7, 16, 22524, 3, NULL),
(32, 'Mathématiques 5', 7, 17, 22524, 2, NULL),
(33, 'Données semi-structurées et bases de données', 7, 17, 22524, 8, NULL),
(34, 'Programmation web', 7, 17, 22524, 3, NULL),
(35, 'Génie logiciel', 7, 17, 22524, 6, NULL),
(36, 'Programmation sous windows', 7, 17, 22524, 4, NULL),
(37, 'Contrôle budgétaire', 7, 17, 22524, 3, NULL),
(38, 'Initiation Python', 7, 17, 22524, 2, NULL),
(39, 'Projet', 7, 17, 22524, 2, NULL),
(40, 'Systèmes informatiques', 8, 18, 22524, 6, NULL),
(41, 'Programmation', 8, 18, 22524, 5, NULL),
(42, 'Base de données avancées', 8, 18, 22524, 3, NULL),
(43, 'Programmation client web', 8, 18, 22524, 3, NULL),
(44, 'Algorithmique des graphes', 8, 18, 22524, 3, NULL),
(45, 'Programmation linéaire', 8, 18, 22524, 3, NULL),
(46, 'Comptabilité de gestion', 8, 18, 22524, 4, NULL),
(47, 'Files d\'attente et gestion de stock', 8, 19, 22524, 3, NULL),
(48, 'Analyse de données', 8, 19, 22524, 3, 13),
(49, 'Programmation d\'application', 8, 19, 22524, 3, NULL),
(51, 'Théorie des langages', 8, 19, 22524, 3, NULL),
(53, 'Anglais', 8, 19, 22524, 3, NULL),
(54, 'Projet', 8, 19, 22524, 4, NULL),
(55, 'Environnement juridique', 8, 19, 22524, 3, NULL),
...
(73, 'Analyse et conception à objet', 9, 22, 22524, 5, 2),
(74, 'Gestion financière', 9, 22, 22524, 3, 14),
(75, 'Management de projet et intégration d\'application', 9, 22, 22524, 6, NULL),
(76, 'Audit informatique', 9, 22, 22524, 3, 13),
(77, 'Entrepreunariat', 9, 22, 22524, 2, 12),
(78, 'Multimedia mobile', 9, 22, 22524, 3, NULL),
(79, 'Ingenierie des exigences et veille technologique', 9, 22, 22524, 3, 10),
(80, 'Mathématiques financières', 9, 22, 22524, 3, NULL),
(81, 'Anglais', 9, 22, 22524, 2, 11),
(82, 'Algorithmique et Programmation', 6, 15, 22524, 5, NULL),
(83, 'Gestion financière', 8, 19, 22524, 3, 14),
(84, 'Analyse de données', 7, 16, 22524, 3, NULL),
(85, 'BMO', 8, 18, 22524, 3, NULL);
...
(39, 'N\'golo Konaté', 6, 12, 5, 'Actif', 'ngolokonate@yahoo.fr', '$2y$10$o7fxEokbRfMLFoGPOS1TpOFuxjFQ3TFzMMV4mukNEWLs9aNxGjr/u'),
(40, 'Nindjin Malan', 6, 12, 5, 'Actif', 'nindjinmalan@gmail.com', '$2y$10$f0Nq70iGpanY5FrbCZI2G.fJ.aj8oDu05Y2Gi5y1LjsrcDc5M3TXa'),
(59, 'Aka Prince', 7, 13, 5, 'Actif', 'prince.aka@miage.edu', '$2y$10$4Ch3UNErI7enw4qTEum.He/je80LyawhwafWzSd1XFpPslQresEdy'),
(79, 'Seri Marie Christine', 4, 7, 5, 'Actif', 'noemietra27@gmail.com', '$2y$10$MU/.mUpi4WcU.YeihVgip.WdJ7EMmZ1vO3NKnH5IclNzcp.zaWUYy'),
(81, 'Brou Kouamé Wa Ambroise', 7, 13, 5, 'Actif', 'kouame.brou@miage.edu', '$2y$10$keRv.zYilWhkPEcFa8zF/uf4fu4mTbHkfF9orQS9zThS3BDU0b/He'),
(82, 'Coulibaly Pécory Ismaèl', 7, 13, 5, 'Actif', 'pecory.coulibaly@miage.edu', '$2y$10$HliFB0N/ZfI2qWPnclw01O8lBMcJjjhhxyqlLqGWjTRRMfnj.WWGC'),
(83, 'Diomandé Gondo Patrick', 7, 13, 5, 'Actif', 'gondo.diomande@miage.edu', '$2y$10$zYnzDrTSquYQmaIYOFkq7eKzL9kqYS/OHO99IEv0PijUvkO.uCVK6'),
(84, 'Ekponou Georges', 7, 13, 5, 'Actif', 'georges.ekponou@miage.edu', '$2y$10$X8VsR9CHU/VwYBaHCrf6MuDhJ9JkUv0Ncz7t1RyGnsEn2om0IMDw2'),
(85, 'Guiégui Arnaud Kévin Boris', 7, 13, 5, 'Actif', 'arnaud.guiegui@miage.edu', '$2y$10$MDqlwgj2HvdJ5NZ0zSF59eyL1ZTkRNa9xidM8guQpVZUlzgziqJjG'),
(86, 'Kéi Ninsémon Hervé', 7, 13, 5, 'Actif', 'herve.kei@miage.edu', '$2y$10$O1mce8rBqd8FMPOEEOzz8u72lU1fYYACaNRl64vs0IygVbKRcPHkK'),
(87, 'Kinimo Habia Elvire', 7, 13, 5, 'Actif', 'elvire.kinimo@miage.edu', '$2y$10$Eb5ji/2./UjVCJFz2kKXuuiCsjgJooZAJYE5woBs6H9BiESPZpiqu'),
(88, 'Kouadio Donald', 7, 13, 5, 'Actif', 'donald.kouadio@miage.edu', '$2y$10$2.Eg0s563GbxmHKklA7SjuPNj.2AgWk7KIInerEOKzOX7VEd3UP.W'),
(89, 'Brou IDA', 5, 10, 4, 'Actif', 'brouida@gmail.com', '$2y$10$osV4q118B2wZAydw0YFmzuqU4WNQbyBd5sat8XxhaW9/96qmqaLy.');
...
(55, 18, 400000.00, '2025-06-16 01:36:18', 'Tranche', 'Chèque'),
(56, 30, 565000.00, '2025-06-25 12:13:45', 'Tranche', 'Carte bancaire');
...
--
ALTER TABLE `action`
  MODIFY `id_action` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `candidature_soutenance`
  MODIFY `id_candidature` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `entreprises`
  MODIFY `id_entreprise` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `informations_stage`
  MODIFY `id_info_stage` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `rapport_etudiants`
  MODIFY `id_rapport` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `traitement`
  MODIFY `id_traitement` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;
...
--
ALTER TABLE `utilisateur`
  MODIFY `id_utilisateur` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=90;

--
-- AUTO_INCREMENT pour la table `versements`
--
ALTER TABLE `versements`
  MODIFY `id_versement` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=57;
...
--
ALTER TABLE `approuver`
  ADD CONSTRAINT `fk_approuver_approb` FOREIGN KEY (`id_approb`) REFERENCES `niveau_approbation` (`id_approb`) ON DELETE CASCADE ON UPDATE CASCADE,
