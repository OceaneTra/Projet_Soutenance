            ...
            <div class="max-w-7xl mx-auto p-6">
                ...
                <div class="flex justify-between items-center mb-8">
                    ...
                    <div class="flex space-x-3">
                        ...
                        <button
                            class="px-4 py-2 bg-yellow-600 text-white text-sm font-medium rounded-md hover:bg-yellow-700 flex items-center">
                ...
                <div class="evaluation-grid mb-8">
                    ...
                    <div
                        ...
                        <div class="p-5">
                            <div class="flex justify-between items-start mb-3">
                                ...
                                <span
                                    class="px-2 py-1 text-xs font-semibold rounded-full bg-blue-100 text-blue-800">Nouveau</span>
                            </div>
                            <p class="text-sm text-gray-600 mb-4">Mémoire de 45 pages sur les systèmes de recommandation
                                basés sur l'apprentissage profond.</p>
                    ...
                    <div
                        ...
                        <div class="p-5">
                            ...
                            <p class="text-sm text-gray-600 mb-4">Implémentation d'une blockchain privée pour le partage
                                sécurisé de dossiers médicaux.</p>
                    ...
                    <div
                        ...
                        <div class="p-5">
                            <div class="flex justify-between items-start mb-3">
                                ...
                                <span
                                    class="px-2 py-1 text-xs font-semibold rounded-full bg-orange-100 text-orange-800">À
                                    corriger</span>
                            </div>
                            <p class="text-sm text-gray-600 mb-4">Analyse des vulnérabilités dans les réseaux IoT
                                industriels et propositions de solutions.</p>
                    ...
                    <div
                        ...
                        <div class="p-5">
                            <div class="flex justify-between items-start mb-3">
                                ...
                                <span class="px-2 py-1 text-xs font-semibold rounded-full bg-gray-100 text-gray-800">En
                                    cours</span>
                            </div>
                            <p class="text-sm text-gray-600 mb-4">Comparaison des modèles de NLP pour l'analyse de
                                sentiment sur les réseaux sociaux.</p>
                ...
                <div class="bg-white rounded-lg shadow p-6 fade-in">
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Système de
                                        recommandation IA</td>
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Blockchain pour la
                                        santé</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">M2 Blockchain 2025
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span
                                            class="px-2 py-1 text-xs font-semibold rounded-full bg-green-100 text-green-800">Validé</span>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-bold text-green-600">16.5/20
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <button class="text-yellow-600 hover:text-yellow-900 mr-3">
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">M2 Cybersécurité 2025
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span
                                            class="px-2 py-1 text-xs font-semibold rounded-full bg-orange-100 text-orange-800">À
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-bold text-orange-600">10.5/20
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <button class="text-yellow-600 hover:text-yellow-900 mr-3">
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Analyse de sentiment
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">M2 Data Science 2025
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span
                    ...
                    <div class="flex items-center justify-between mt-4">
                        ...
                        <div class="flex space-x-2">
                            ...
                            <button
                                class="px-3 py-1 border border-gray-300 rounded-md text-sm font-medium text-white bg-yellow-600 hover:bg-yellow-700">
                                1
                            </button>
                            <button
                                class="px-3 py-1 border border-gray-300 rounded-md text-sm font-medium text-gray-700 bg-white hover:bg-gray-50">
