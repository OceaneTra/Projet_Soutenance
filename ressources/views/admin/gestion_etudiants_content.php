                    ...
                    <?php foreach ($listeEtudiants as $etudiant): ?>
                        <tr class="table-row-hover">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                <span class="bg-gray-100 px-2 py-1 rounded-md"><?php echo htmlspecialchars($etudiant->num_etu); ?></span>
                            </td>
            ...
            <div class="flex items-center justify-between">
                <p class="text-sm text-gray-700">
                    Affichage de <span class="font-medium">1</span> à <span
                            class="font-medium"><?php echo !empty($listeEtudiants) ? count($listeEtudiants) : 0; ?></span> sur <span
                            class="font-medium"><?php echo !empty($listeEtudiants) ? count($listeEtudiants) : 0; ?></span> résultats
                </p>
