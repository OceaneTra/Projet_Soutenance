...
<body class="bg-gray-100">
    <div class="min-h-screen flex flex-col">
        <main class="flex-grow container mx-auto px-4 py-5">
                ...
                <form method="POST" action="?page=parametres_generaux&action=niveaux_acces">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        <div>
                            ...
                            <input type="text" id="niveaux_acces" name="niveaux_acces" required
                    ...
                    <div class="flex justify-start space-x-3">
                        <button type="submit" name="btn_add_niveaux_acces"
            ...
            <div class="mt-8">
                <h3 class="text-xl font-semibold text-gray-700 mb-4">Liste des niveaux d'accès</h3>
                <form method="POST" action="?page=parametres_generaux&action=niveaux_acces" id="formListeNiveauAcces">
