...
<div class="min-h-screen flex flex-col">
    <main class="flex-grow container mx-auto px-4 py-5">
        ...
        <div class="bg-white rounded-xl shadow-lg p-6 md:p-8 mb-8">
            ...
            <form method="POST" action="?page=parametres_generaux&action=entreprises">
                <?php if ($entreprises_a_modifier): ?>
                    <input type="hidden" name="id_entreprise"
                           value="<?= htmlspecialchars($entreprises_a_modifier->id_entreprise) ?>">
                <?php endif; ?>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        <label class="block text-sm font-medium text-gray-600 mb-3 outline-none">Nom de l'entreprise
                        </label>
                        <input type="text" id="entreprises" name="entreprise" required
        ...
        <div class="mt-8">
            <h3 class="text-xl font-semibold text-gray-700 mb-4">Liste des entreprises</h3>
