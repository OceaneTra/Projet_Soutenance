        ...
        <main class="container mx-auto px-4 py-8">
            ...
            <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
                <h3 class="text-lg font-semibold text-gray-600 mb-4 flex items-center">
                    <i class="fas <?= isset($_GET['id_fonction']) ? 'fa-edit text-green-500' : 'fa-plus-circle text-green-500' ?> mr-2"></i>
                ...
                <form method="POST" action="?page=parametres_generaux&action=fonctions" id="fonctionForm">
                    ...
                    <div class="mb-4">
                        <label for="lib_fonction" class="block text-sm font-medium text-gray-700 mb-2">Libellé de la fonction</label>
                    ...
                    <div class="flex justify-between mt-6">
                        ...
                        <button type="submit" name="submit_edit_fonction"
                        ...
                        <?php else: ?>
                        <div></div>
                        <button type="submit" name="submit_add_fonction"
                            class="btn-hover px-4 py-2 btn-gradient-primary text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2">
            ...
            <div class="bg-white rounded-lg shadow-sm">
                <div class="p-6">
                    <h3 class="text-lg font-semibold text-gray-600 mb-4">Liste des fonctions</h3>
                    <form method="POST" action="?page=parametres_generaux&action=fonctions" id="deleteForm">
                        ...
                        <div class="mt-4 flex justify-end">
                            <button type="submit" name="btn_supprimer_fonction" id="deleteButton"
