...
<body class="bg-gray-100">
    ...
    <div class="min-h-screen flex flex-col">
        <main class="flex-grow container mx-auto px-4 py-8">
            ...
            <div class="bg-white rounded-xl shadow-lg p-6 md:p-8 mb-8 transform transition-all duration-300 hover:shadow-xl">
                ...
                <form method="POST" action="?page=parametres_generaux&action=fonctions" id="fonctionForm" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="form-group">
                            <label for="lib_fonction" class="block text-sm font-medium text-gray-700 mb-1">
                                Libellé de la fonction <span class="text-red-500">*</span>
                            </label>
                            <input type="text" id="lib_fonction" name="fonction" required
                            ...
                            <div class="text-red-500 text-sm mt-1 hidden" id="lib_fonction-error"></div>
                        </div>
                    </div>
                    ...
                    <div class="flex justify-start space-x-3 mt-6">
                        <?php if (isset($_GET['id_fonction'])): ?>
                            <button type="submit" name="btn_add_fonction"
                                ...
                                <i class="fas fa-save mr-2"></i> Modifier la fonction
                            </button>
                        ...
                        <?php else: ?>
                            <button type="submit" name="btn_add_fonction"
                                ...
                                <i class="fas fa-plus mr-2"></i> Ajouter la fonction
                            </button>
                        <?php endif; ?>
                    </div>
                </form>
            ...
            <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                <div class="p-6">
                    <div class="overflow-x-auto">
                        <table id="fonctionTable" class="w-full">
                                ...
                                <?php if (!empty($listeFonctions)) : ?>
                                    <?php foreach ($listeFonctions as $fonction) : ?>
                                        <tr class="hover:bg-gray-50 transition-colors">
                                            ...
                                            <td class="px-4 py-3 text-sm text-gray-900 font-medium"><?= htmlspecialchars($fonction->id_fonction) ?></td>
                                            <td class="px-4 py-3 text-sm text-gray-700"><?= htmlspecialchars($fonction->lib_fonction) ?></td>
                                            <td class="px-4 py-3 text-center">
    ...
    <script>
        $(document).ready(function() {
            ...
            const table = $('#fonctionTable').DataTable({
                dom: 'Bfrtip',
                buttons: [
                    {
                        extend: 'excel',
