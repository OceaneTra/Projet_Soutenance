...
$total_items = count($listeFonctions);
$total_pages = ceil($total_items / $limit);

// Slice the array for pagination
$listeFonctions = array_slice($listeFonctions, $offset, $limit);
?>
<!DOCTYPE html>
<html lang="fr">
...
<body class="bg-gray-50">
        ...
        <main class="container mx-auto px-4 py-8">
            ...
            <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
                <h3 class="text-lg font-semibold text-gray-600 mb-4 flex items-center">
                    <i
                        class="fas <?= isset($_GET['id_fonction']) ? 'fa-edit text-green-500' : 'fa-plus-circle text-green-500' ?> mr-2"></i>
                    <?= isset($_GET['id_fonction']) ? 'Modifier la fonction' : 'Ajouter une nouvelle fonction' ?>
                </h3>

                <form method="POST" action="?page=parametres_generaux&action=fonctions" id="fonctionForm">
                    <?php if($fonction_a_modifier): ?>
                    <input type="hidden" name="id_fonction"
                        value="<?= htmlspecialchars($fonction_a_modifier->id_fonction) ?>">
                    <?php endif; ?>

                    <div class="mb-4">
                        <label for="lib_fonction" class="block text-sm font-medium text-gray-700 mb-2">Libellé de la
                            fonction</label>
                        <input type="text" name="lib_fonction" id="lib_fonction" required
                    ...
                    <div class="flex justify-between mt-6">
                        ...
                        <button type="button" name="btn_annuler" id="btnAnnuler"
                            onclick="window.location.href='?page=parametres_generaux&action=fonctions'"
                    ...
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <div class="flex-1 max-w-md">
                            <form action="" method="GET" class="flex gap-3">
                                ...
                                <input type="hidden" name="action" value="fonctions">
                                    ...
                                    <tr class="hover:bg-gray-50">
                                        <td class="px-6 py-4 whitespace-nowrap text-center">
                                            <input type="checkbox" name="selected_ids[]"
                                                value="<?= htmlspecialchars($fonction->id_fonction) ?>"
            ...
            <div class="bg-white rounded-lg shadow-sm p-4 mt-6">
                <div class="flex flex-col sm:flex-row justify-between items-center gap-4">
                    ...
                    <div class="flex flex-wrap justify-center gap-2">
                        <?php if ($page > 1): ?>
                        <a href="?page=parametres_generaux&action=fonctions&p=<?= $page - 1 ?>&search=<?= urlencode($search) ?>"
                        ...
                        for ($i = $start; $i <= $end; $i++):
                        ?>
                        <a href="?page=parametres_generaux&action=fonctions&p=<?= $i ?>&search=<?= urlencode($search) ?>"
        ...
        <div class="bg-white rounded-lg p-6 max-w-sm w-full mx-4 animate__animated animate__zoomIn">
            <div class="text-center">
                ...
                <p class="text-sm text-gray-500 mb-6">
                    ...
                    Êtes-vous sûr de vouloir supprimer les fonctions sélectionnés ?
                </p>
    ...
    <div id="modifyModal"
        ...
        <div class="bg-white rounded-lg p-6 max-w-sm w-full mx-4 animate__animated animate__zoomIn">
            <div class="text-center">
                ...
                <p class="text-sm text-gray-500 mb-6">
                    <i class="fas fa-info-circle mr-2"></i>
                    Êtes-vous sûr de vouloir modifier cette fonction ?
                </p>
                <div class="flex justify-center gap-4">
    ...
    const formListeFonctions = document.getElementById('formListeFonctions');
    ...
    const fonctionForm = document.getElementById('fonctionForm');
    const submitModifierHidden = document.getElementById('btn_modifier_fonction_hidden');
    ...
    function exportToExcel() {
        ...
        link.setAttribute('download', 'fonctions.csv');
