                ...
                <form method="POST" action="?page=parametres_generaux&action=messages" id="messageForm"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="form-group">
                            ...
                            class=" form-input w-full px-4 py-2.5 border border-gray-300 rounded-lg shadow-sm
                            focus:ring-2 focus:ring-green-500 focus:border-green-500 focus:outline-green-500
                            transition-colors"
                            placeholder="Saisissez votre message
                            ici..."><?= $message_a_modifier ? htmlspecialchars($message_a_modifier->contenu_message) : '' ?></input>
                        ...
                        <table id="messageTable" class="w-full">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">Contenu
                                    </th>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="px-4 py-3 text-sm text-gray-900 font-medium">
                                        <?= htmlspecialchars($message->id_message) ?></td>
                                    <td class="px-4 py-3 text-sm text-gray-700">
                                        <?= htmlspecialchars($message->contenu_message) ?></td>
                                    <td class="px-4 py-3 text-center">
