...
>>>>>>> ca2717c9dd5fd17d8353b610c3251922be196b38
        ...
        <div class="bg-white rounded-xl shadow-lg p-6 md:p-8 mb-8">
            ...
            <form method="POST" action="?page=parametres_generaux&action=traitements">
        ...
        <div class="mt-8">
            <h3 class="text-xl font-semibold text-gray-700 mb-4">Liste des traitements</h3>
            <form method="POST" action="?page=parametres_generaux&action=traitements" id="formListeTraitement">
                                    ...
                                    <?php foreach ($listeTraitement as $traitement) : ?>
                                        <tr class="hover:bg-gray-50 transition-colors">
                                            <td class="px-4 py-3 whitespace-nowrap text-center">
                                                <input type="checkbox" name="selected_ids[]" value="<?= htmlspecialchars($traitement->id_traitement) ?>"
