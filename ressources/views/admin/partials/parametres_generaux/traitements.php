    ...
    <div class="min-h-screen flex flex-col">
        <main class="flex-grow container mx-auto px-4 py-5">
            ...
            <div class="bg-white rounded-xl shadow-lg p-6 md:p-8 mb-8">
                ...
                <form method="POST" action="?page=parametres_generaux&action=traitement">
            ...
            <div class="mt-8">
                ...
                <form method="POST" action="?page=parametres_generaux&action=traitement" id="formListeTraitement">
