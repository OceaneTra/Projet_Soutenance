        ...
        <main class="container mx-auto px-4 py-8">
            ...
            <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
                <h3 class="text-lg font-semibold text-gray-600 mb-4 flex items-center">
                    <i class="fas <?= isset($_GET['id_traitement']) ? 'fa-edit text-green-500' : 'fa-plus-circle text-green-500' ?> mr-2"></i>
                ...
                <form method="POST" action="?page=parametres_generaux&action=traitements" id="traitementForm">
                    ...
                    <input type="hidden" name="id_traitement" value="<?= htmlspecialchars($traitement_a_modifier->id_traitement) ?>">
                    <?php endif ?>
