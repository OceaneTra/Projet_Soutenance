...
<body class="bg-gray-100">
        ...
        <main class="flex-grow container mx-auto px-4 py-8">
            ...
            <div class="mb-6">
                <div class="flex justify-between items-center mb-4">
                    <h2 class="text-2xl font-bold text-gray-700">Gestion des Traitements</h2>
                ...
                <form method="POST" action="?page=parametres_generaux&action=traitements" id="traitementForm"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="form-group">
                            <label for="lib_traitement" class="block text-sm font-medium text-gray-700 mb-1">
                                Libellé du traitement <span class="text-red-500">*</span>
                            </label>
                            <input type="text" id="lib_traitement" name="traitement" required
                                value="<?= $traitement_a_modifier ? htmlspecialchars($traitement_a_modifier->lib_traitement) : '' ?>"
                                placeholder="Ex: Validation des notes"
                            ...
                            <div class="text-red-500 text-sm mt-1 hidden" id="lib_traitement-error"></div>
                        </div>
                    </div>
            ...
            <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                <div class="p-6">
                    <div class="overflow-x-auto">
                        <table id="traitementTable" class="w-full">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">Libellé
                                    </th>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="px-4 py-3 text-sm text-gray-900 font-medium">
                                        <?= htmlspecialchars($traitement->id_traitement) ?></td>
                                    <td class="px-4 py-3 text-sm text-gray-700">
                                        <?= htmlspecialchars($traitement->lib_traitement) ?></td>
                                    <td class="px-4 py-3 text-center">
                                        <div class="flex justify-center space-x-2">
                                            ...
                                            <button type="button"
                                                ...
                                                data-id="<?= $traitement->id_traitement ?>">
    ...
    $(document).ready(function() {
        ...
        const table = $('#traitementTable').DataTable({
            dom: 'Bfrtip',
            buttons: [{
                    extend: 'excel',
