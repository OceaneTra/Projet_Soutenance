...
if (!empty($search)) {
    $listeNiveaux = array_filter($listeNiveaux, function($niveauEtude) use ($search) {
        return stripos($niveauEtude->lib_niv_etude, $search) !== false;
    });
}
...
<body class="bg-gray-50">
    ...
    <div class="min-h-screen">
        <main class="container mx-auto px-4 py-8">
            ...
            <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
                ...
                <form method="POST" action="?page=parametres_generaux&action=niveaux_etude" id="niveauEtudeForm">
                    ...
                    <div class="mb-4">
                        <label for="lib_niv_etude" class="block text-sm font-medium text-gray-700 mb-2">Libellé du
                            niveau</label>
                        <input type="text" name="lib_niv_etude" id="lib_niv_etude" required
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    ...
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-center text-sm">
                                            <a href="?page=parametres_generaux&action=niveaux_etude&id_niv_etude=<?= htmlspecialchars($niveau->id_niv_etude) ?>"
    ...
    const niveauEtudeForm = document.getElementById('niveauEtudeForm');
    const submitModifierHidden = document.getElementById('btn_modifier_niveau_etude_hidden');
    ...
    confirmModify.addEventListener('click', function() {
        if (submitModifierHidden) {
            ...
            if (niveauEtudeForm) niveauEtudeForm.submit();
        }
