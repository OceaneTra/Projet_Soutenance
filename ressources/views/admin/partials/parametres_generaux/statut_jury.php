    ...
    <div class="min-h-screen flex flex-col">
        <main class="flex-grow container mx-auto px-4 py-5">
            ...
            <div class="bg-white rounded-xl shadow-lg p-6 md:p-8 mb-8">
                ...
                <form method="POST" action="?page=parametres_generaux&action=statut_jury">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        <div>
                            <label class="block text-sm font-medium text-gray-600 mb-3 outline-none">Libellé du
                                statut du jury</label>
                            <input type="text" id="statut_jury" name="statut_jury" required
            ...
            <div class="mt-8">
                <h3 class="text-xl font-semibold text-gray-700 mb-4">Liste des statuts du jury</h3>
                            ...
                            <div class="overflow-x-auto w-full">
                                <table class="w-full divide-y divide-gray-200">
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        <?php $listeStatuts = $GLOBALS['listeStatuts'] ?? []; ?>
                                        ...
                                        <tr>
                                            <td colspan="4" class="text-center text-sm text-gray-500 py-4">
                                                Aucun statut de jury enregistré.
                                            </td>
                                        </tr>
                                        <?php endif; ?>
                                    </tbody>
