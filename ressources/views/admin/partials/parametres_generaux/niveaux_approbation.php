    ...
    <div class="min-h-screen">
        <main class="container mx-auto px-4 py-8">
            ...
            <div class="bg-white rounded-lg shadow-sm">
                <div class="p-6">
                    <h3 class="text-lg font-semibold text-gray-600 mb-4">Liste des niveaux d'approbation</h3>
                    <form method="POST" action="?page=parametres_generaux&action=niveaux_approbation" id="deleteForm">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    ...
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-center text-sm">
                                            <a href="?page=parametres_generaux&action=niveaux_approbation&id_niveau=<?= htmlspecialchars($niveau->id_niveau) ?>"
