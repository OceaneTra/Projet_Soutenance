        ...
        <main class="flex-grow container mx-auto px-4 py-8">
            <div class="mb-6 flex justify-between items-center">
                ...
                <a href="?route=admin/dashboard"
                    class="bg-gray-200 hover:bg-gray-300 text-gray-700 font-bold py-2 px-4 rounded">Retour</a>
            </div>
            ...
            <div class="bg-white rounded-lg shadow p-6 mb-6">
                ...
                <form method="POST" action="?route=admin/parametres/annee-academique">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div>
                            <label for="date_deb" class="block text-sm font-medium text-gray-700 mb-1">Date
                                début</label>
