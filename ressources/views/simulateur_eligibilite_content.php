...
<body class="bg-gray-50 font-sans antialiased">
    <div class="flex h-screen overflow-hidden">
        <!-- Sidebar (identique à votre structure existante) -->
        <div class="hidden md:flex md:flex-shrink-0">
            <div class="flex flex-col w-64 border-r border-gray-200 bg-white">
                <div class="flex items-center justify-center h-16 px-4 bg-green-100 shadow-sm">
                    <div class="flex overflow-hidden items-center">
                        <a href="?page=candidater_soutenance" class="text-green-500 font-bold text-xl">Soutenance Manager</a>
                    </div>
                </div>
        ...
        <div class="flex flex-col flex-1 overflow-hidden">
            ...
            <div class="flex items-center justify-between h-16 px-4 border-b border-gray-200 bg-green-100 shadow-sm">
                <div class="flex items-center">
                    ...
                    <h1 class="text-lg font-medium text-green-500">Simulateur d'éligibilité</h1>
                </div>
            ...
            <div class="flex-1 p-4 md:p-6 overflow-y-auto">
                <div class="max-w-4xl mx-auto bg-white rounded-xl shadow-md overflow-hidden">
                    ...
                    <div class="p-6 bg-gradient-to-r from-green-50 to-blue-50 border-b border-gray-200">
                        ...
                        <p class="text-gray-600 mb-4">Vérifiez si vous remplissez toutes les conditions pour candidater à la soutenance.</p>
                    ...
                    <div class="p-6">
                        ...
                        <div class="mb-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">Numéro d'étudiant</label>
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="requirement-item p-4 border rounded-lg flex items-start" id="req1">
                                    ...
                                    <div class="flex-grow">
                                        ...
                                        <p class="text-sm text-gray-600 mt-1">Votre rapport de stage doit être validé par votre tuteur pédagogique.</p>
                                ...
                                <div class="requirement-item p-4 border rounded-lg flex items-start" id="req2">
                                    ...
                                    <div class="flex-grow">
                                        ...
                                        <p class="text-sm text-gray-600 mt-1">Votre tuteur en entreprise doit avoir complété la fiche d'évaluation.</p>
                                        <div class="mt-2 text-sm text-green-600 font-medium">
                                            <i class="fas fa-check mr-1"></i> Condition remplie
                                        </div>
                                    </div>
                                ...
                                <!-- Item 3 -->
                                <div class="requirement-item p-4 border rounded-lg flex items-start bg-yellow-50" id="req3">
                                    <div class="mr-3 mt-1">
                                        <i class="fas fa-exclamation-circle text-yellow-500 text-xl"></i>
                                    </div>
                                    <div class="flex-grow">
                                        <h4 class="font-medium text-gray-800">Soutenance blanche réalisée</h4>
                                        <p class="text-sm text-gray-600 mt-1">Vous devez avoir effectué votre soutenance blanche avec validation.</p>
                                ...
                                <!-- Item 4 -->
                                <div class="requirement-item p-4 border rounded-lg flex items-start bg-red-50" id="req4">
                                    <div class="mr-3 mt-1">
                                        <i class="fas fa-times-circle text-red-500 text-xl"></i>
                                    </div>
                                    <div class="flex-grow">
                                        <h4 class="font-medium text-gray-800">Dépôt du mémoire</h4>
                                        <p class="text-sm text-gray-600 mt-1">Votre mémoire doit être déposé et validé par votre directeur de mémoire.</p>
                        ...
                        <div class="mt-8 flex flex-col sm:flex-row justify-end space-y-3 sm:space-y-0 sm:space-x-3">
                            <button class="px-4 py-2 border border-gray-300 rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
                                <i class="fas fa-download mr-2"></i> Exporter en PDF
                            </button>
                            <button class="px-4 py-2 border border-transparent rounded-md shadow-sm text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 disabled:opacity-50" disabled>
                    ...
                    <div class="p-6">
                        ...
                        <div class="space-y-4">
                            <div class="border-b border-gray-200 pb-4">
                                <button class="faq-question flex justify-between items-center w-full text-left font-medium text-gray-700 hover:text-green-600 focus:outline-none">
                                ...
                                <div class="faq-answer mt-2 text-gray-600 hidden">
                                    <p>Si une condition n'est pas remplie, vous verrez un lien ou une indication sur la marche à suivre pour la remplir. Dans certains cas, vous devrez contacter votre tuteur ou l'administration.</p>
                                </div>
                            </div>
                            ...
                            <div class="border-b border-gray-200 pb-4">
                                ...
                                <div class="faq-answer mt-2 text-gray-600 hidden">
                                    <p>Le temps de validation dépend de la condition. Pour les validations par un enseignant, cela peut prendre jusqu'à 5 jours ouvrés. Nous vous recommandons de ne pas attendre la dernière minute pour remplir vos obligations.</p>
                                </div>
                            </div>
                            ...
                            <div class="border-b border-gray-200 pb-4">
                                ...
                                <div class="faq-answer mt-2 text-gray-600 hidden">
                                    <p>Non, toutes les conditions doivent être validées (statut vert) avant de pouvoir candidater. Les validations en cours (statut orange) ne permettent pas encore de soumettre votre candidature.</p>
                                </div>
                            </div>
                        </div>
                    </div>
