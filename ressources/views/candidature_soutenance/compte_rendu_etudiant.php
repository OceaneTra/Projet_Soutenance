            ...
            <div class="flex-1 p-4 md:p-6 overflow-y-auto gradient-bg">
                <div class="max-w-6xl mx-auto">
                    ...
                    <div class="mb-8 text-center fade-in">
                        ...
                        <p class="text-gray-600 max-w-2xl mx-auto">Voici le détail de l'évaluation de votre dossier par
                            la commission pédagogique.</p>
                    </div>
                        ...
                        <div class="p-6 md:p-8">
                            <div class="flex flex-col md:flex-row items-center">
                                <div class="w-full md:w-1/3 mb-6 md:mb-0 flex justify-center">
                                    <div class="relative w-32 h-32">
                                        <svg class="w-full h-full" viewBox="0 0 100 100">
                                            ...
                                            <!-- Progress circle -->
                                            <circle class="text-green-500" stroke-width="8" stroke-dasharray="251.2"
                                                stroke-dashoffset="75.36" stroke-linecap="round" stroke="currentColor"
                                                fill="transparent" r="40" cx="50" cy="50" />
                                        </svg>
                                        <div
                                ...
                                <div class="w-full md:w-2/3 md:pl-8">
                                    <h2 class="text-xl font-semibold text-gray-800 mb-2">Statut de votre candidature
                                    </h2>
                                    <div class="mb-4">
                                    ...
                                    <p class="text-gray-600 mb-4">Votre dossier est en cours d'évaluation par la
                                        commission. Vous recevrez une notification dès que la décision finale sera
                                        prise.</p>
                                    ...
                                    <div class="bg-blue-50 p-4 rounded-lg">
                                        <div class="flex items-start">
                                            ...
                                            <div class="ml-3">
                                                ...
                                                <p class="text-sm text-gray-600">"Le sujet est très pertinent et bien
                                                    traité. La bibliographie pourrait être plus complète."</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="bg-green-50 p-4 rounded-lg">
                                        <div class="flex items-start">
                                            ...
                                            <div class="ml-3">
                                                ...
                                                <p class="text-sm text-gray-600">"Excellente présentation des résultats.
                                                    Les conclusions pourraient être plus développées."</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="bg-purple-50 p-4 rounded-lg">
                                        <div class="flex items-start">
                                            ...
                                            <div class="ml-3">
                                                ...
                                                <p class="text-sm text-gray-600">"La méthodologie est solide mais manque
                                                    de détails sur certains points techniques."</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="bg-white rounded-xl shadow-md overflow-hidden mb-8 fade-in"
                        ...
                        <div class="p-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <!-- Document 1 -->
                                <div
                                    class="document-card bg-gray-50 rounded-lg p-4 border border-gray-200 transition duration-300 ease-in-out hover:shadow-md">
                                    <div class="flex items-start">
