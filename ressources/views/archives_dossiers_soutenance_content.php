                ...
                <div class="bg-white rounded-lg shadow p-6 fade-in">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold text-gray-900"><?php echo $statistiques['total_archives'] ?? 0; ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow p-6 fade-in">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold text-gray-900"><?php echo $statistiques['temps_moyen_traitement'] ?? 0; ?>j</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="filter-section rounded-lg p-6 mb-8 fade-in">
                ...
                <form method="GET" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4">
                    <div>
                        ...
                        <select name="statut" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                            <option value="">Tous les statuts</option>
                            <option value="valider" <?php echo ($filtres['statut'] ?? '') === 'valider' ? 'selected' : ''; ?>>Validés</option>
                            <option value="rejeter" <?php echo ($filtres['statut'] ?? '') === 'rejeter' ? 'selected' : ''; ?>>Rejetés</option>
                        </select>
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Année</label>
                        <select name="annee" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                    ...
                    <div>
                        ...
                        <input type="text" name="enseignant" value="<?php echo htmlspecialchars($filtres['enseignant'] ?? ''); ?>" 
                    ...
                    <div>
                        ...
                        <input type="text" name="etudiant" value="<?php echo htmlspecialchars($filtres['etudiant'] ?? ''); ?>" 
                               placeholder="Nom ou prénom" 
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    ...
                    <div class="xl:col-span-6 flex justify-end space-x-4">
                        ...
                        <a href="?page=archives_dossiers_soutenance" class="bg-gray-500 text-white px-6 py-2 rounded-md hover:bg-gray-600 transition-colors">
            ...
            <div class="mb-6">
                <div class="flex justify-between items-center">
                    <h3 class="text-lg font-semibold text-gray-800">
                        ...
                        Rapports archivés (<?php echo count($rapportsArchives); ?> résultat<?php echo count($rapportsArchives) > 1 ? 's' : ''; ?>)
                    </h3>
                    ...
                    <div class="bg-white rounded-lg shadow-md border border-gray-200 card-hover fade-in">
                        ...
                        <div class="p-6 border-b border-gray-200">
                            <div class="flex justify-between items-start mb-4">
                                ...
                                <div class="ml-4">
                                    <span class="status-badge inline-flex items-center px-3 py-1 rounded-full text-sm font-medium border <?php echo getStatusClass($rapport['decision_validation']); ?>">
                        ...
                        <div class="p-6">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="flex justify-between text-xs">
                                    ...
                                    <span class="text-gray-900 font-medium"><?php echo $rapport['nombre_evaluations'] ?? 0; ?></span>
                                </div>
                            </div>
                            ...
                            <?php if (!empty($rapportsArchives)): ?>
                                ...
                                <tr class="hover:bg-gray-50">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo getStatusClass($rapport['decision_validation']); ?>">
                                            <i class="<?php echo getStatusIcon($rapport['decision_validation']); ?> mr-1"></i>
                                            <?php echo ucfirst($rapport['decision_validation']); ?>
                                        </span>
                                    </td>
