                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-semibold text-gray-700"><?= $statistiquesCompteRendu['total'] ?? 0 ?></p>
                        </div>
                    </div>
                </div>
                <div class="bg-white rounded-lg shadow-md p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-semibold text-gray-700"><?= $statistiquesCompteRendu['semaine'] ?? 0 ?></p>
                        </div>
                    </div>
                </div>
                <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <div class="bg-white rounded-lg shadow-md">
            ...
            <div class="p-4 border-b border-gray-200 bg-gray-50">
                <form method="GET" class="flex flex-wrap gap-4">
                    ...
                    <select name="statut" class="px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                    ...
                    En cours
                            ...
                            <div class="mt-4">
                                ...
                                <div class="flex space-x-2">
                                    <a href="?page=gestion_rapports&action=compte_rendu_rapport&id=<?= $rapport['id_rapport'] ?>"
