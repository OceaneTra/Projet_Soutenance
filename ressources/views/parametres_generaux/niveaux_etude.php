...
<body class="bg-gray-50">
    ...
    <div class="min-h-screen">
        <main class="container mx-auto px-4 py-8">
            ...
            <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
                ...
                <form method="POST" action="?page=parametres_generaux&action=niveaux_etude" id="niveauForm">
                    <?php if($niveau_a_modifier): ?>
                    <input type="hidden" name="id_niv_etude"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        <!-- Libellé Niveau -->
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Libellé du niveau</label>
                        ...
                        <!-- Montant scolarite -->
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Montant de la scolarité</label>
                            <input type="number" id="montant_scolarite" name="montant_scolarite" required
                                value="<?= $niveau_a_modifier ? htmlspecialchars($niveau_a_modifier->montant_scolarite) : '' ?>"
                                placeholder="Entrer le montant de la scolarité"
                                class="form-input w-full px-3 py-2 mb-3 border border-gray-300 rounded-md focus:outline-4 focus:outline-green-300 focus:ring-green-300 focus:border-green-300 focus:ring-opacity-50 transition-all duration-200">
                        </div>
                        <!-- Montant inscription -->
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Montant de l'inscription</label>
                            <input type="number" id="montant_inscription" name="montant_inscription" required
                                value="<?= $niveau_a_modifier ? htmlspecialchars($niveau_a_modifier->montant_inscription) : '' ?>"
                    ...
                    <div class="flex justify-between mt-6">
                        ...
                        <button type="button" id="btnModifier" name="btn_modifier_niveau"
                            ...
                            <input type="hidden" name="btn_modifier_niveau" id="btn_modifier_niveau_hidden" value="0">
                        </button>
                        <?php else: ?>
                        <div></div>
            ...
            <div class="bg-white rounded-lg shadow-sm p-6">
                ...
                <form class="overflow-x-auto" method="POST" action="?page=parametres_generaux&action=niveaux_etude"
                    id="formListeNiveaux">
                    ...
                    <table class="w-full">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-4 py-3 text-sm text-gray-700">
                                    <?= htmlspecialchars($niveau->montant_scolarite) ?>
                                </td>
                                <td class="px-4 py-3 text-sm text-gray-700">
                    ...
                    <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                        ...
                        <div>
                            <nav class="relative z-0 inline-flex rounded-md shadow-sm -space-x-px"
                                ...
                                <?php if ($page > 1): ?>
                                <a href="?page=parametres_generaux&action=niveaux_etude&p=<?= $page - 1 ?>&search=<?= urlencode($search) ?>"
        ...
        <div class="bg-white rounded-lg p-6 max-w-sm w-full mx-4 animate__animated animate__zoomIn">
            <div class="text-center">
                ...
                <p class="text-sm text-gray-500 mb-6">
                    ...
                    Êtes-vous sûr de vouloir supprimer les niveaux d'étude sélectionnés ?
                </p>
    ...
    <div id="modifyModal"
        ...
        <div class="bg-white rounded-lg p-6 max-w-sm w-full mx-4 animate__animated animate__zoomIn">
            <div class="text-center">
                ...
                <p class="text-sm text-gray-500 mb-6">
                    <i class="fas fa-info-circle mr-2"></i>
                    Êtes-vous sûr de vouloir modifier ce niveau d'étude ?
                </p>
                <div class="flex justify-center gap-4">
    ...
    const submitModifierHidden = document.getElementById('btn_modifier_niveau_hidden');
    ...
    function exportToExcel() {
        ...
        link.setAttribute('download', 'niveaux_etude.csv');
