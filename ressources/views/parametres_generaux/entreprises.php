...
$total_items = count($listeEntreprises);
$total_pages = ceil($total_items / $limit);

// Slice the array for pagination
$listeEntreprises = array_slice($listeEntreprises, $offset, $limit);
?>
...
<body class="bg-gray-50">
        ...
        <div class="bg-white rounded-lg p-6 max-w-sm w-full mx-4 animate__animated animate__zoomIn">
            <div class="text-center">
                ...
                <p class="text-sm text-gray-500 mb-6">
                    ...
                    Êtes-vous sûr de vouloir supprimer les entreprises sélectionnés ?
                </p>
    ...
    <div id="modifyModal"
        ...
        <div class="bg-white rounded-lg p-6 max-w-sm w-full mx-4 animate__animated animate__zoomIn">
            <div class="text-center">
                ...
                <p class="text-sm text-gray-500 mb-6">
                    <i class="fas fa-info-circle mr-2"></i>
                    Êtes-vous sûr de vouloir modifier cet entreprise ?
                </p>
                <div class="flex justify-center gap-4">
    ...
    const formListeEntreprises = document.getElementById('formListeEntreprises');
    ...
    const submitModifierHidden = document.getElementById('btn_modifier_entreprise_hidden');
